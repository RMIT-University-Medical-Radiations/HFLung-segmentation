...
CMD 'nnUNetv2_plan_and_preprocess -d 138 --verify_dataset_integrity -gpu_memory_target 24 && \
    ...
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 3d_fullres 3 -device cuda --npz; \
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 3d_fullres 4 -device cuda --npz; \
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 3d_lowres 0 -device cuda --npz; \
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 3d_lowres 1 -device cuda --npz; \
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 3d_lowres 2 -device cuda --npz; \
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 3d_lowres 3 -device cuda --npz; \
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 3d_lowres 4 -device cuda --npz; \
    nnUNetv2_train -tr nnUNetTrainer_60epochs 138 2d 0 -device cuda --npz; \
