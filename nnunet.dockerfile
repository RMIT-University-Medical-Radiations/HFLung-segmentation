...
#     nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_fullres 0 -device cuda --npz ; \
CMD nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_fullres 1 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_fullres 2 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_fullres 3 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_fullres 4 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_lowres 0 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_lowres 1 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_lowres 2 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_lowres 3 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 3d_lowres 4 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 2d 0 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 2d 1 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 2d 2 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 2d 3 -device cuda --npz ; \
    nnUNetv2_train -tr nnUNetTrainerDA5_60epochs 138 2d 4 -device cuda --npz
